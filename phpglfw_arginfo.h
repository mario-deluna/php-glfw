...
#define arginfo_glHint arginfo_glCullFace

#define arginfo_glLineWidth arginfo_glCullFace

#define arginfo_glPointSize arginfo_glCullFace

#define arginfo_glPolygonMode arginfo_glCullFace

#define arginfo_glScissor arginfo_glCullFace

#define arginfo_glTexParameterf arginfo_glCullFace

#define arginfo_glTexParameteri arginfo_glCullFace

#define arginfo_glDrawBuffer arginfo_glCullFace

#define arginfo_glClear arginfo_glCullFace

#define arginfo_glClearColor arginfo_glCullFace

#define arginfo_glClearStencil arginfo_glCullFace

#define arginfo_glClearDepth arginfo_glCullFace

#define arginfo_glStencilMask arginfo_glCullFace

#define arginfo_glColorMask arginfo_glCullFace

#define arginfo_glDepthMask arginfo_glCullFace

#define arginfo_glDisable arginfo_glCullFace

#define arginfo_glEnable arginfo_glCullFace

#define arginfo_glFinish arginfo_glCullFace

#define arginfo_glFlush arginfo_glCullFace

#define arginfo_glBlendFunc arginfo_glCullFace

#define arginfo_glLogicOp arginfo_glCullFace

#define arginfo_glStencilFunc arginfo_glCullFace

#define arginfo_glStencilOp arginfo_glCullFace

#define arginfo_glDepthFunc arginfo_glCullFace

#define arginfo_glPixelStoref arginfo_glCullFace

#define arginfo_glPixelStorei arginfo_glCullFace

#define arginfo_glReadBuffer arginfo_glCullFace

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_glGetError, 0, 0, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_glIsEnabled, 0, 0, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

#define arginfo_glDepthRange arginfo_glCullFace

#define arginfo_glViewport arginfo_glCullFace

#define arginfo_glDrawArrays arginfo_glCullFace

#define arginfo_glPolygonOffset arginfo_glCullFace

#define arginfo_glCopyTexImage1D arginfo_glCullFace

#define arginfo_glCopyTexImage2D arginfo_glCullFace

#define arginfo_glCopyTexSubImage1D arginfo_glCullFace

#define arginfo_glCopyTexSubImage2D arginfo_glCullFace

#define arginfo_glBindTexture arginfo_glCullFace

#define arginfo_glIsTexture arginfo_glIsEnabled

#define arginfo_glCopyTexSubImage3D arginfo_glCullFace

#define arginfo_glActiveTexture arginfo_glCullFace

#define arginfo_glSampleCoverage arginfo_glCullFace

#define arginfo_glBlendFuncSeparate arginfo_glCullFace

#define arginfo_glPointParameterf arginfo_glCullFace

#define arginfo_glPointParameteri arginfo_glCullFace

#define arginfo_glBlendColor arginfo_glCullFace

#define arginfo_glBlendEquation arginfo_glCullFace

#define arginfo_glIsQuery arginfo_glIsEnabled

#define arginfo_glBeginQuery arginfo_glCullFace

#define arginfo_glEndQuery arginfo_glCullFace

#define arginfo_glBindBuffer arginfo_glCullFace

#define arginfo_glIsBuffer arginfo_glIsEnabled

#define arginfo_glUnmapBuffer arginfo_glIsEnabled

#define arginfo_glBlendEquationSeparate arginfo_glCullFace

#define arginfo_glStencilOpSeparate arginfo_glCullFace

#define arginfo_glStencilFuncSeparate arginfo_glCullFace

#define arginfo_glStencilMaskSeparate arginfo_glCullFace

#define arginfo_glAttachShader arginfo_glCullFace

#define arginfo_glCompileShader arginfo_glCullFace

#define arginfo_glCreateProgram arginfo_glGetError

#define arginfo_glCreateShader arginfo_glGetError

#define arginfo_glDeleteProgram arginfo_glCullFace

#define arginfo_glDeleteShader arginfo_glCullFace

#define arginfo_glDetachShader arginfo_glCullFace

#define arginfo_glDisableVertexAttribArray arginfo_glCullFace

#define arginfo_glEnableVertexAttribArray arginfo_glCullFace

#define arginfo_glIsProgram arginfo_glIsEnabled

#define arginfo_glIsShader arginfo_glIsEnabled

#define arginfo_glLinkProgram arginfo_glCullFace

#define arginfo_glUseProgram arginfo_glCullFace

#define arginfo_glUniform1f arginfo_glCullFace

#define arginfo_glUniform2f arginfo_glCullFace

#define arginfo_glUniform3f arginfo_glCullFace

#define arginfo_glUniform4f arginfo_glCullFace

#define arginfo_glUniform1i arginfo_glCullFace

#define arginfo_glUniform2i arginfo_glCullFace

#define arginfo_glUniform3i arginfo_glCullFace

#define arginfo_glUniform4i arginfo_glCullFace

#define arginfo_glValidateProgram arginfo_glCullFace

#define arginfo_glVertexAttrib1d arginfo_glCullFace

#define arginfo_glVertexAttrib1f arginfo_glCullFace

#define arginfo_glVertexAttrib1s arginfo_glCullFace

#define arginfo_glVertexAttrib2d arginfo_glCullFace

#define arginfo_glVertexAttrib2f arginfo_glCullFace

#define arginfo_glVertexAttrib2s arginfo_glCullFace

#define arginfo_glVertexAttrib3d arginfo_glCullFace

#define arginfo_glVertexAttrib3f arginfo_glCullFace

#define arginfo_glVertexAttrib3s arginfo_glCullFace

#define arginfo_glVertexAttrib4Nub arginfo_glCullFace

#define arginfo_glVertexAttrib4d arginfo_glCullFace

#define arginfo_glVertexAttrib4f arginfo_glCullFace

#define arginfo_glVertexAttrib4s arginfo_glCullFace

#define arginfo_glColorMaski arginfo_glCullFace

#define arginfo_glEnablei arginfo_glCullFace

#define arginfo_glDisablei arginfo_glCullFace

#define arginfo_glIsEnabledi arginfo_glIsEnabled

#define arginfo_glBeginTransformFeedback arginfo_glCullFace

#define arginfo_glEndTransformFeedback arginfo_glCullFace

#define arginfo_glBindBufferRange arginfo_glCullFace

#define arginfo_glBindBufferBase arginfo_glCullFace

#define arginfo_glClampColor arginfo_glCullFace

#define arginfo_glBeginConditionalRender arginfo_glCullFace

#define arginfo_glEndConditionalRender arginfo_glCullFace

#define arginfo_glVertexAttribI1i arginfo_glCullFace

#define arginfo_glVertexAttribI2i arginfo_glCullFace

#define arginfo_glVertexAttribI3i arginfo_glCullFace

#define arginfo_glVertexAttribI4i arginfo_glCullFace

#define arginfo_glVertexAttribI1ui arginfo_glCullFace

#define arginfo_glVertexAttribI2ui arginfo_glCullFace

#define arginfo_glVertexAttribI3ui arginfo_glCullFace

#define arginfo_glVertexAttribI4ui arginfo_glCullFace

#define arginfo_glUniform1ui arginfo_glCullFace

#define arginfo_glUniform2ui arginfo_glCullFace

#define arginfo_glUniform3ui arginfo_glCullFace

#define arginfo_glUniform4ui arginfo_glCullFace

#define arginfo_glClearBufferfi arginfo_glCullFace

#define arginfo_glIsRenderbuffer arginfo_glIsEnabled

#define arginfo_glBindRenderbuffer arginfo_glCullFace

#define arginfo_glRenderbufferStorage arginfo_glCullFace

#define arginfo_glIsFramebuffer arginfo_glIsEnabled

#define arginfo_glBindFramebuffer arginfo_glCullFace

#define arginfo_glCheckFramebufferStatus arginfo_glGetError

#define arginfo_glFramebufferTexture1D arginfo_glCullFace

#define arginfo_glFramebufferTexture2D arginfo_glCullFace

#define arginfo_glFramebufferTexture3D arginfo_glCullFace

#define arginfo_glFramebufferRenderbuffer arginfo_glCullFace

#define arginfo_glGenerateMipmap arginfo_glCullFace

#define arginfo_glBlitFramebuffer arginfo_glCullFace

#define arginfo_glRenderbufferStorageMultisample arginfo_glCullFace

#define arginfo_glFramebufferTextureLayer arginfo_glCullFace

#define arginfo_glFlushMappedBufferRange arginfo_glCullFace

#define arginfo_glBindVertexArray arginfo_glCullFace

#define arginfo_glIsVertexArray arginfo_glIsEnabled

#define arginfo_glDrawArraysInstanced arginfo_glCullFace

#define arginfo_glTexBuffer arginfo_glCullFace

#define arginfo_glPrimitiveRestartIndex arginfo_glCullFace

#define arginfo_glCopyBufferSubData arginfo_glCullFace

#define arginfo_glUniformBlockBinding arginfo_glCullFace

#define arginfo_glProvokingVertex arginfo_glCullFace

#define arginfo_glFenceSync arginfo_glGetError

#define arginfo_glIsSync arginfo_glIsEnabled

#define arginfo_glDeleteSync arginfo_glCullFace

#define arginfo_glClientWaitSync arginfo_glGetError

#define arginfo_glWaitSync arginfo_glCullFace

#define arginfo_glFramebufferTexture arginfo_glCullFace

#define arginfo_glTexImage2DMultisample arginfo_glCullFace

#define arginfo_glTexImage3DMultisample arginfo_glCullFace

#define arginfo_glSampleMaski arginfo_glCullFace
