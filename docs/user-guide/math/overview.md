...
- [Vectors](/user-guide/math/vectors.html): `Vec2`, `Vec3`, `Vec4` for positions, directions, and colors.
- [Quaternions](/user-guide/math/quaternions.html): `Quat` for smooth, gimbal-free rotation.
- [Matrices](/user-guide/math/matrices.html): `Mat4` for transforms, cameras, and projection.
- [Working in 3D Space](/user-guide/math/working-in-3d-space.html): puts it all together into a real render.
...
- [`Vec2`](/API/Math/Vec2.html), [`Vec3`](/API/Math/Vec3.html), [`Vec4`](/API/Math/Vec4.html) are vectors with 2, 3, and 4 components.
- [`Quat`](/API/Math/Quat.html) is a quaternion, used to represent a rotation.
- [`Mat4`](/API/Math/Mat4.html) is a 4x4 matrix, used to transform points and build cameras.
...
Matrices have no named properties. You access their 16 elements purely by index, for reasons the [Matrices](/user-guide/math/matrices.html) page explains.
...
- New to this? Start with [Vectors](/user-guide/math/vectors.html), the foundation everything else builds on.
- Trying to rotate something smoothly? See [Quaternions](/user-guide/math/quaternions.html).
- Building a camera or transforming a model? See [Matrices](/user-guide/math/matrices.html).
- Ready to draw a 3D object on screen? Jump straight to [Working in 3D Space](/user-guide/math/working-in-3d-space.html).
