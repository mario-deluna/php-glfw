...
PHP-GLFW aims to be one extension containing all the basics you need to start building graphical applications in PHP. That means that PHP-GLFW **does NOT just
...
This extension comes with bindings for the amazing **[GLFW](https://www.glfw.org)** library. GLFW offers great features, including:
...
There is a simple installer script you can use to install php-glfw:
...
That's it! If you see the text "Installation finished!" you should be ready to go!
