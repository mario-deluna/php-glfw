...
`$vertices` is now a [FloatBuffer](../../API/Buffer/FloatBuffer.md) object that contains the positions of all vertices in the .obj file.
...
One main difference between the `getVertices` and `getMeshes` method is that the `getMeshes` method returns an array of [Mesh](../../API/Geometry/ObjFileParserMesh.md) objects.
...
Many of the methods in this class allow you to pass a [Group](../../API/Geometry/ObjFileParserGroup.md) argument. 
